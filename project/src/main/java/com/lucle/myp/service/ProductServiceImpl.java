...
public class ProductServiceImpl implements ProductService {
	...
	public List<SearchStatVo> getStatList(Criteria cri) {
	    ...
	    for(SearchStatVo vo : list) {
	        Long category = vo.getCATEGORY(); // category 값 가져오기
	        
	        // category 값에 따라 categoryName 설정
	        if (Long.valueOf(1111).equals(category)) {
	            ...
	            vo.setPname("엡손프로젝터");
	        } else if (Long.valueOf(2111).equals(category)) {
	            vo.setPname("엘지데스크탑");
	        } else if (Long.valueOf(2112).equals(category)) {
	            vo.setPname("삼성데스크탑");
	        } else if (Long.valueOf(2113).equals(category)) {
	            vo.setPname("한성데스크탑");
	        } else if (Long.valueOf(2121).equals(category)) {
	            vo.setPname("엘지노트북");
	        } else if (Long.valueOf(2122).equals(category)) {
	            vo.setPname("삼성노트북");
	        } else if (Long.valueOf(2123).equals(category)) {
	            vo.setPname("레노버노트북");
	        } else if (Long.valueOf(2131).equals(category)) {
	            vo.setPname("엘지모니터");
	        } else if (Long.valueOf(2132).equals(category)) {
	            vo.setPname("삼성모니터");
	        } else if (Long.valueOf(2133).equals(category)) {
	            vo.setPname("필립스모니터");
	        } else if (Long.valueOf(2211).equals(category)) {
	            vo.setPname("AMD CPU");
	        } else if (Long.valueOf(2212).equals(category)) {
	            vo.setPname("인텔 CPU");
	        } else if (Long.valueOf(2221).equals(category)) {
	            vo.setPname("ASUS 메인보드");
	        } else if (Long.valueOf(2222).equals(category)) {
	        	vo.setPname("MSI 메인보드");
	        } else if (Long.valueOf(2223).equals(category)) {
	            vo.setPname("ASROCK 메인보드");
	        } else if (Long.valueOf(2231).equals(category)) {
	            vo.setPname("삼성 램");
	        } else if (Long.valueOf(2232).equals(category)) {
	            vo.setPname("SK하이닉스 램");
	        } else if (Long.valueOf(2233).equals(category)) {
	            vo.setPname("마이크론 램");
	        } else if (Long.valueOf(2311).equals(category)) {
	            vo.setPname("로지텍 마우스");
	        } else if (Long.valueOf(2312).equals(category)) {
	            vo.setPname("레이저 마우스");
	        } else if (Long.valueOf(2321).equals(category)) {
	            vo.setPname("로지텍 키보드");
	        } else if (Long.valueOf(2322).equals(category)) {
	            vo.setPname("앱코 키보드");
	        } else {
	            vo.setPname("미등록상품");
	        }
