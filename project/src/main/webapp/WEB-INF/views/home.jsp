			...
			<div id="content main-content">
				...
				<div class="container-fluid">
						...
						<c:forEach var="product" items="${products}" begin="0" end="3">
							<div class="col-xl-3 col-md-6 mb-4">
								...
								<img class="img-fluid px-3 px-sm-4 mt-3 mb-4"
									style="width: 25rem;" src="${product.imgUrl}"
									alt="Product Image"> <br> <a
									href="/market/pr?keyword=${product.keyword}"> <c:choose>
					...
					<div class="row">
						<c:forEach var="product2" items="${products2}" begin="0" end="3">
							<div class="col-xl-3 col-md-6 mb-4">
								...
								<img class="img-fluid px-3 px-sm-4 mt-3 mb-4"
									style="width: 25rem;" src="${product2.imgUrl}"
									alt="Product Image"> <br> <a
									href="/market/pr?keyword=${product2.keyword}"> <c:choose>
					...
					<div>
						<ul>
							<!-- 최근 본 상품 목록을 반복하여 표시 -->
							<c:forEach items="${sessionScope.recentViewedProducts}"
								var="product">
								<li>
									<div>
										...
										<!-- 상품 이미지 -->
										<h2>
											<a href="/market/pr?keyword=${product.keyword}">${product.productName}</a>
										</h2>
										<!-- 상품 이름이 링크로 되어 있으며, 클릭 시 keyword 파라미터와 함께 /market/pr로 이동 -->
										<span>${product.won}</span>
										<!-- 상품 가격 -->
									</div>
								</li>
							</c:forEach>
						...
						<div class="col">
							...
							<div class="container">
								<div class="mb-3">
									<form action="/market/search" method="get">
										...
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="inlineCheckbox1" name="type" value="11st"
												checked="checked"> <label class="form-check-label"
												for="inlineCheckbox1">11번가</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="inlineCheckbox4" name="type" value="ebay"
												checked="checked"> <label class="form-check-label"
												for="inlineCheckbox4">Ebay</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
												id="inlineCheckbox2" name="type" value="ama"
												checked="checked"> <label class="form-check-label"
												for="inlineCheckbox2">Amazon</label>
										</div>
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="checkbox"
									...
									<img
										src="https://cdn.011st.com/11dims/resize/248/11src/pd/v2/2/4/3/3/4/5/IbOMi/2823243345_B.png"
										alt="Image">
