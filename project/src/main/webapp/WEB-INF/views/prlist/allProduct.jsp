						    ...
						    <nav aria-label="Page navigation">
						        <ul class="pagination justify-content-center">
						            <c:if test="${pageMaker.prev}">
						                <li class="page-item">
						                    <a class="page-link" href="${pageContext.request.contextPath}/prlist/allProduct?page=${pageMaker.startPage - 1}" aria-label="Previous">
						                        &laquo; 이전
						                    </a>
						                </li>
						            </c:if>
						            ...
						            <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
						                <c:choose>
						                    ...
						                    <c:otherwise>
						                        <li class="page-item">
						                            <a class="page-link" href="${pageContext.request.contextPath}/prlist/allProduct?page=${pageNum}">
						                                ${pageNum}
						                            </a>
						                        </li>
						                    </c:otherwise>
						            ...
						            <c:if test="${pageMaker.next}">
						                <li class="page-item">
						                    <a class="page-link" href="${pageContext.request.contextPath}/prlist/allProduct?page=${pageMaker.endPage + 1}" aria-label="Next">
						                        다음 &raquo;
						                    </a>
						                </li>
						            </c:if>
