                ...
                <div class="container-fluid">
                    ...
                    <div class="pagination">
                        <c:if test="${pageMaker.prev}">
                            <a href="${pageContext.request.contextPath}/prlist/allProduct?page=${pageMaker.startPage - 1}" class="btn">&laquo; 이전</a>
                        </c:if>
                        ...
                        <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="${pageContext.request.contextPath}/prlist/allProduct?page=${pageNum}" class="btn">${pageNum}</a>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>

                        <c:if test="${pageMaker.next}">
                            <a href="${pageContext.request.contextPath}/prlist/allProduct?page=${pageMaker.endPage + 1}" class="btn">다음 &raquo;</a>
                        </c:if>
                    </div>
                </div>
            </div>
